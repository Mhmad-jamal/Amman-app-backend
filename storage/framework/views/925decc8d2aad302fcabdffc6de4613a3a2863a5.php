            ...
            <div class="row">
                <div class="col-12 ">
                    <div class="card card-body border-0 shadow mb-4">
                        ...
                        <input disabled type="hidden" value="<?php echo e($property->id); ?>" name="id">
                        <input disabled type="hidden" value="<?php echo e($property->owner_id); ?>" name="owner_id">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input disabled class="form-control" id="sub_section" name="sub_section"
                                            value="<?php echo e($property->sub_section); ?>" type="text">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input disabled class="form-control" id="ad_details" name="ad_details"
                                                type="text" value="<?php echo e($property->ad_details); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label style="margin-left: 10px">
                                                    <input disabled type="radio" name="selected_features" value="<?php echo e($feature); ?>"
                                                        <?php echo e(in_array($feature, $property->features) ? 'checked' : ''); ?>>
                                                    <?php echo e($feature); ?>
...
<?php endif; ?>
<?php /**PATH D:\github\Amman-app-backend\resources\views/property/view.blade.php ENDPATH**/ ?>