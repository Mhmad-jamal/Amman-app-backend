                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select disabled class="form-control" id="payment_type" name="payment_type">
                                                <option value="cash" {{ $property->payment_type == 'cash' ? 'selected' : '' }}>كــاش</option>
                                                <option value="installments" {{ $property->payment_type == 'installments' ? 'selected' : '' }}>اقساط</option>
                                            </select>
                                    ...
                                    @foreach ($features as $key => $value)
                                        ...
                                        <div class="col-md-3">
                                            <label style="margin-left: 10px">
                                                <input disabled type="checkbox" name="features[]" value="{{ $key }}"
